...
})(exports.GoldenMetrics || (exports.GoldenMetrics = {}));

var goldenMetrics = [{
  type: 'counter',
  name: exports.GoldenMetrics.AppLoaded,
  description: 'Application loaded counter'
}, {
  type: 'counter',
  name: exports.GoldenMetrics.AppUnloaded,
  description: 'Application unloaded counter'
}, {
  type: 'histogram',
  name: exports.GoldenMetrics.PageNavigation,
  description: 'Total navigation duration between pages in seconds'
}, {
  type: 'histogram',
  name: exports.GoldenMetrics.PageTimeToComplete,
  description: 'Section time to interactive in seconds'
}, {
  type: 'histogram',
  name: exports.GoldenMetrics.PageTimeToUsable,
  description: 'Section time to usable in seconds'
}, {
  type: 'histogram',
  name: exports.GoldenMetrics.PerformanceTime,
...
var createMetrics = function createMetrics(registry, defaultBuckets) {
  ...
  if (registry.get('counter', exports.GoldenMetrics.AppLoaded)) {
...
var MetricsProvider = function MetricsProvider(_ref) {
  ...
  react.useEffect(function () {
    observe(exports.GoldenMetrics.AppLoaded, {
      status: 'success'
    });
  ...
  reactBeforeunload.useBeforeunload(function () {
    observe(exports.GoldenMetrics.AppUnloaded, {}, undefined, true);
    sendMetrics(true);
  });
  reactPerformance.useNavigationListener(function (navigation) {
    ...
    observe(exports.GoldenMetrics.PageNavigation, tags, duration / 1000, true);
    observe(exports.GoldenMetrics.PageTimeToComplete, tags, timeToComplete / 1000, true);
    observe(exports.GoldenMetrics.PageTimeToUsable, tags, timeToUsable / 1000, true);
    sendMetrics();
  });
  reactPerformance.useLifecycleEventListener(function (_ref2) {
    var type = _ref2.type,
        start = _ref2.start;
    observe(exports.GoldenMetrics.PerformanceTime, {
      event_type: type
    }, start / 1000, true);
  });
